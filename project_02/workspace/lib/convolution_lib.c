        ...
        pixel_row, uint16_t pixel_column, uint16_t cm_row)
{
    ...
    img_position.currently_row = pixel_row - distance + cm_row;
    ...
    while(cm_position.currently_column < cm.order)
    {
        ...
        // near to the borders).
        if(img_position.currently_row >= 0 && img_position.currently_row <
                img.height && img_position.currently_column >= 0 &&
                img_position.currently_column < img.width)
        {
